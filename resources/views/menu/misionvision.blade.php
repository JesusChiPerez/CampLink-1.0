...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/menu/misionvision.css') }}">
@endpush
                ...
                <div class="mv-body">
                    ...
                    <div class="mv-box mv-mision">
                        ...
                        <p>
                            ...
                            colaboración solidaria entre los distintos actores del mercado.
                        </p>
                    </div>

                    <!-- Visión -->
                    <div class="mv-box mv-vision">
                        <h4>Visión</h4>
                        <p>
                            ...
                            comercial más justo, eficiente y accesible.
                        </p>
                    </div>
